 ...
 */
#ifndef LIBBITCOIN_MESSAGE_INVENTORY_VECTOR_IPP
#define LIBBITCOIN_MESSAGE_INVENTORY_VECTOR_IPP
...
template <typename Iterator, bool SafeCheckLast>
inventory_vector::inventory_vector(deserializer<Iterator, SafeCheckLast>& deserial)
{
    deserialize(deserial);
}

template<typename Iterator>
inventory_vector::inventory_vector(const Iterator begin, const Iterator end)
{
