 ...
 */
#ifndef LIBBITCOIN_BLOCKCHAIN_PRIMITIVE_SCRIPT_IPP
#define LIBBITCOIN_BLOCKCHAIN_PRIMITIVE_SCRIPT_IPP

namespace libbitcoin {

template <typename Iterator, bool SafeCheckLast>
void script_type::deserialize(deserializer<Iterator, SafeCheckLast>& deserial,
...
template <typename Iterator, bool SafeCheckLast>
script_type::script_type(deserializer<Iterator, SafeCheckLast>& deserial,
    bool allow_raw_data_fallback)
{
...
script_type::script_type(const Iterator begin, const Iterator end,
    bool allow_raw_data_fallback)
{
...
size_t script_type::read_operation_data_byte_count(opcode code,
