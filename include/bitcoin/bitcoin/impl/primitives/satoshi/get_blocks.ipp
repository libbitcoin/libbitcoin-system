 ...
 */
#ifndef LIBBITCOIN_SATOSHI_PRIMITIVE_GET_BLOCKS_IPP
#define LIBBITCOIN_SATOSHI_PRIMITIVE_GET_BLOCKS_IPP

namespace libbitcoin {

template <typename Iterator, bool SafeCheckLast>
void get_blocks_type::deserialize(deserializer<Iterator, SafeCheckLast>& deserial)
{
...
template <typename Iterator, bool SafeCheckLast>
get_blocks_type::get_blocks_type(deserializer<Iterator, SafeCheckLast>& deserial)
{
    deserialize(deserial);
}

template<typename Iterator>
get_blocks_type::get_blocks_type(const Iterator begin, const Iterator end)
{
