 ...
 */
#ifndef LIBBITCOIN_SATOSHI_PRIMITIVE_VERSION_IPP
#define LIBBITCOIN_SATOSHI_PRIMITIVE_VERSION_IPP

namespace libbitcoin {

template <typename Iterator, bool SafeCheckLast>
void version_type::deserialize(deserializer<Iterator, SafeCheckLast>& deserial)
{
...
template <typename Iterator, bool SafeCheckLast>
version_type::version_type(deserializer<Iterator, SafeCheckLast>& deserial)
{
    deserialize(deserial);
}

template<typename Iterator>
version_type::version_type(const Iterator begin, const Iterator end)
{
