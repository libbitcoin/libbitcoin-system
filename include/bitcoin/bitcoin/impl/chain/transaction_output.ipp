 ...
 */
#ifndef LIBBITCOIN_CHAIN_TRANSACTION_OUTPUT_IPP
#define LIBBITCOIN_CHAIN_TRANSACTION_OUTPUT_IPP
...
template <typename Iterator, bool SafeCheckLast>
transaction_output::transaction_output(deserializer<Iterator, SafeCheckLast>& deserial)
{
    deserialize(deserial);
}

template<typename Iterator>
transaction_output::transaction_output(const Iterator begin, const Iterator end)
{
