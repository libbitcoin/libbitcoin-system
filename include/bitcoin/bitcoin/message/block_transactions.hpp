...
public:
    ...
    static block_transactions factory_from_data(const uint32_t version, const data_chunk& data);
    static block_transactions factory_from_data(const uint32_t version, std::istream& stream);
    static block_transactions factory_from_data(const uint32_t version, reader& source);
