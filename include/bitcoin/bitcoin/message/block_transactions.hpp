...
public:
    ...
    static block_transactions factory_from_data(const data_chunk& data);
    static block_transactions factory_from_data(std::istream& stream);
    static block_transactions factory_from_data(reader& source);
