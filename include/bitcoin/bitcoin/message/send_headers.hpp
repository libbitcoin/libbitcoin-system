...
public:
    ...
    static send_headers factory_from_data(const uint32_t version, const data_chunk& data);
    static send_headers factory_from_data(const uint32_t version, std::istream& stream);
