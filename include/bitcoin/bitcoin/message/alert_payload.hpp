...
{
public:
    static alert_payload factory_from_data(const data_chunk& data);
    static alert_payload factory_from_data(std::istream& stream);
    static alert_payload factory_from_data(reader& source);
