...
public:
    ...
    static send_compact_blocks factory_from_data(const data_chunk& data);
    static send_compact_blocks factory_from_data(std::istream& stream);
    static send_compact_blocks factory_from_data(reader& source);
