 ...
 */
#ifndef LIBBITCOIN_SYSTEM_WALLET_MNEMONICS_DICTIONARY_HPP
#define LIBBITCOIN_SYSTEM_WALLET_MNEMONICS_DICTIONARY_HPP
...
#include <bitcoin/system/impl/wallet/mnemonics/dictionary.ipp>
