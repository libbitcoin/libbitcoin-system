 ...
 */
#ifndef LIBBITCOIN_SYSTEM_WALLET_MNEMONICS_DICTIONARIES_HPP
#define LIBBITCOIN_SYSTEM_WALLET_MNEMONICS_DICTIONARIES_HPP
...
#include <bitcoin/system/impl/wallet/mnemonics/dictionaries.ipp>
