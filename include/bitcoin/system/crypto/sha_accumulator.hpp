 ...
 */
#ifndef LIBBITCOIN_SYSTEM_CRYPTO_SHA_ACCUMULATOR_HPP
#define LIBBITCOIN_SYSTEM_CRYPTO_SHA_ACCUMULATOR_HPP
...
#include <bitcoin/system/impl/crypto/sha_accumulator.ipp>
