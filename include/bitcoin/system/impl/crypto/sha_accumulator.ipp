 ...
 */
#ifndef LIBBITCOIN_SYSTEM_CRYPTO_SHA_ACCUMULATOR_IPP
#define LIBBITCOIN_SYSTEM_CRYPTO_SHA_ACCUMULATOR_IPP
...
inline bool context::write(size_t size, const uint8_t* in) NOEXCEPT
{
    ...
    accumulate(state_, unsafe_vector_cast<block>(in, blocks));
