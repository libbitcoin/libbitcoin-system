 ...
 */
#ifndef LIBBITCOIN_SYSTEM_MESSAGES_NETWORK_ADDRESS_HPP
#define LIBBITCOIN_SYSTEM_MESSAGES_NETWORK_ADDRESS_HPP
...
struct BC_API network_address
{
    ...
    typedef std::shared_ptr<const network_address> ptr;

    static size_t size(uint32_t version, bool with_timestamp);
    static network_address deserialize(uint32_t version, reader& source,
        bool with_timestamp);
