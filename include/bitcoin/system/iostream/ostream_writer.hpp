 ...
 */
#ifndef LIBBITCOIN_SYSTEM_IOSTREAM_OSTREAM_WRITER_HPP
#define LIBBITCOIN_SYSTEM_IOSTREAM_OSTREAM_WRITER_HPP
...
#include <bitcoin/system/impl/iostream/ostream_writer.ipp>
