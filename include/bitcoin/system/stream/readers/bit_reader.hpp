...
#ifndef LIBBITCOIN_SYSTEM_STREAM_READERS_BIT_READER_HPP
#define LIBBITCOIN_SYSTEM_STREAM_READERS_BIT_READER_HPP
...
#include <bitcoin/system/impl/stream/readers/bit_reader.ipp>
