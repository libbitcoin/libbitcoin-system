 ...
 */
#ifndef LIBBITCOIN_SYSTEM_STREAM_READERS_BYTE_READER_HPP
#define LIBBITCOIN_SYSTEM_STREAM_READERS_BYTE_READER_HPP
...
#include <bitcoin/system/impl/stream/readers/byte_reader.ipp>
