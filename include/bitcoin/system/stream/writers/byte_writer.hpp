 ...
 */
#ifndef LIBBITCOIN_SYSTEM_STREAM_WRITERS_BYTE_WRITER_HPP
#define LIBBITCOIN_SYSTEM_STREAM_WRITERS_BYTE_WRITER_HPP
...
/// A byte writer that accepts an istream.
...
#include <bitcoin/system/impl/stream/writers/byte_writer.ipp>
