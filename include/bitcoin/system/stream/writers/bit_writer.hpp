...
#ifndef LIBBITCOIN_SYSTEM_STREAM_WRITERS_BIT_WRITER_HPP
#define LIBBITCOIN_SYSTEM_STREAM_WRITERS_BIT_WRITER_HPP
...
#include <bitcoin/system/impl/stream/writers/bit_writer.ipp>
