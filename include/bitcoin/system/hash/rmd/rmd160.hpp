 ...
 */
#ifndef LIBBITCOIN_SYSTEM_HASH_RMD_RMD160_HPP
#define LIBBITCOIN_SYSTEM_HASH_RMD_RMD160_HPP
  ...
  : public k<160>
{
    ...
    static constexpr schedule_t word
    {
        // parallel one, r'(j)
    ...
    static constexpr schedule_t rot
    {
        // parallel one, s(j)
