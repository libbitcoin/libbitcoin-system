 ...
 */
#ifndef LIBBITCOIN_SYSTEM_CONCURRENCY_RESUBSCRIBER_HPP
#define LIBBITCOIN_SYSTEM_CONCURRENCY_RESUBSCRIBER_HPP
...
#include <bitcoin/system/impl/concurrency/resubscriber.ipp>
