 ...
 */
#ifndef LIBBITCOIN_SYSTEM_CONCURRENCY_SUBSCRIBER_HPP
#define LIBBITCOIN_SYSTEM_CONCURRENCY_SUBSCRIBER_HPP
...
#include <bitcoin/system/impl/concurrency/subscriber.ipp>
