...
DEFINE_ERROR_T_MESSAGE_MAP(op_error)
{
    ...
    { op_check_sig_schnorr3, "op_check_sig_schnorr3" },
    { op_check_sig_budget, "op_check_sig_budget" },
    { op_check_sig_decode_signature, "op_check_sig_decode_signature" },
    ...
    { op_check_multisig_decode_signature, "op_check_multisig_decode_signature" },
    ...
    { op_check_sig_add1, "op_check_sig_add1" },
    { op_check_sig_add2, "op_check_sig_add2" },
    { op_check_sig_add3, "op_check_sig_add3" },
    { op_check_sig_add4, "op_check_sig_add4" },
    { op_check_sig_add5, "op_check_sig_add5" },
    { op_check_sig_add6, "op_check_sig_add6" },
    { op_check_sig_add7, "op_check_sig_add7" }
};
