...
network_address_type::network_address_type(const data_chunk& value)
{
...
network_address_type::operator const data_chunk() const
{
...
size_t network_address_type::satoshi_size() const
{
    return network_address_type::satoshi_fixed_size();
}

size_t network_address_type::satoshi_fixed_size()
{
    return 26;
}
