...
inline bool op_count_overflow(size_t op_count)
{
...
static bool update_op_counter(const operation& op, evaluation_context& context)
{
    ...
    return !op_count_overflow(context.operation_counter);
}
