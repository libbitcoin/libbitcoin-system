...
message_subscriber::message_subscriber(threadpool& pool)
  : INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, address),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, alert),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, block),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, filter_add),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, filter_clear),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, filter_load),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, get_address),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, get_blocks),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, get_data),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, get_headers),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, inventory),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, memory_pool),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, merkle_block),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, not_found),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, ping),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, pong),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, reject),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, transaction),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, verack),
    INITIALIZE_SUBSCRIBER(pool, LOG_NETWORK, version)
{
}
