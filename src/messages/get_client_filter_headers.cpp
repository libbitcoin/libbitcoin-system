...
const uint32_t get_client_filter_headers::version_minimum = version::level::minimum;
const uint32_t get_client_filter_headers::version_maximum = version::level::maximum;
