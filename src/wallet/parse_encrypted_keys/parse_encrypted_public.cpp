...
const byte_array<parse_encrypted_public::magic_size> parse_encrypted_public::magic_
{
    { 0x64, 0x3b, 0xf6, 0xa8 }
};

byte_array<parse_encrypted_public::prefix_size> parse_encrypted_public::prefix_factory(
    uint8_t address)
{
