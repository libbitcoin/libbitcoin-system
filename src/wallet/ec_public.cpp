...
BC_CONSTEXPR uint8_t ec_public::compressed_even = 0x02;
BC_CONSTEXPR uint8_t ec_public::compressed_odd = 0x03;
BC_CONSTEXPR uint8_t ec_public::uncompressed = 0x04;
BC_CONSTEXPR uint8_t ec_public::mainnet_p2kh = 0x00;
