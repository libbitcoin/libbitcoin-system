...
const uint32_t get_compact_filter_headers::version_minimum = version::level::bip157;
const uint32_t get_compact_filter_headers::version_maximum = version::level::bip157;
