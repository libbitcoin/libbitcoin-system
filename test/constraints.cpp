...
////static_assert(!is_true<if_byte<uint256_t>>());
...
static_assert(is_true<if_bytes<uint256_t>>());
...
static_assert(is_true<if_size_of<bool, sizeof(bool)>>());
static_assert(is_true<if_size_of<int, sizeof(int)>>());
static_assert(is_true<if_size_of<int8_t, sizeof(uint8_t)>>());
static_assert(is_true<if_size_of<int16_t, sizeof(uint16_t)>>());
static_assert(is_true<if_size_of<int32_t, sizeof(uint32_t)>>());
static_assert(is_true<if_size_of<int64_t, sizeof(uint64_t)>>());
static_assert(is_true<if_size_of<signed_size_t, sizeof(size_t)>>());
////static_assert(!is_true<if_size_of<bool, sizeof(int)>>());
////static_assert(!is_true<if_size_of<int, sizeof(bool)>>());
...
//static_assert(!is_true<if_unique_object_representations<std::string>>());
////static_assert(!is_true<if_unique_object_representations<base>>());
////static_assert(!is_true<if_unique_object_representations<derived>>());
