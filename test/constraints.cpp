...
////static_assert(is_same_type<to_signed_type<size_t>, signed_size_t>);
////static_assert(is_same_type<to_signed_type<signed_size_t>, signed_size_t>);
////static_assert(is_same_type<to_unsigned_type<signed_size_t>, size_t>);
