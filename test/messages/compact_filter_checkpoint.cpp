...
{
    messages::compact_filter_checkpoint instance;
...
BOOST_AUTO_TEST_CASE(compact_filter_checkpoint__constructor_2__always__equals_params)
{
    ...
    messages::compact_filter_checkpoint instance(filter_type, stop_hash, filter_headers);
...
BOOST_AUTO_TEST_CASE(compact_filter_checkpoint__constructor_3__always__equals_params)
{
    ...
    messages::compact_filter_checkpoint instance(filter_type, std::move(dup_stop), std::move(dup_filter_headers));
...
BOOST_AUTO_TEST_CASE(compact_filter_checkpoint__constructor_4__always__equals_params)
{
    ...
    messages::compact_filter_checkpoint value(filter_type, stop_hash, filter_headers);

    messages::compact_filter_checkpoint instance(value);
    BOOST_REQUIRE(instance.is_valid());
    BOOST_REQUIRE(filter_type == instance.filter_type());
    BOOST_REQUIRE(stop_hash == instance.stop_hash());
    BOOST_REQUIRE(filter_headers == instance.filter_headers());
...
BOOST_AUTO_TEST_CASE(compact_filter_checkpoint__constructor_5__always__equals_params)
{
    ...
    messages::compact_filter_checkpoint instance(std::move(value));
    BOOST_REQUIRE(instance.is_valid());
    BOOST_REQUIRE(filter_type == instance.filter_type());
    BOOST_REQUIRE(stop_hash == instance.stop_hash());
    BOOST_REQUIRE(filter_headers == instance.filter_headers());
...
BOOST_AUTO_TEST_CASE(compact_filter_checkpoint__from_data__insufficient_bytes__failure)
{
    ...
    messages::compact_filter_checkpoint instance;
    BOOST_REQUIRE_EQUAL(false, instance.from_data(messages::compact_filter_checkpoint::version_minimum, raw));
}
...
BOOST_AUTO_TEST_CASE(compact_filter_checkpoint__from_data__insufficient_version__failure)
{
    ...
    messages::compact_filter_checkpoint expected;
    auto result = expected.from_data(messages::compact_filter_checkpoint::version_minimum, raw);
    BOOST_REQUIRE_EQUAL(true, result);
    BOOST_REQUIRE_EQUAL(true, expected.is_valid());

    const auto data = expected.to_data(messages::compact_filter_checkpoint::version_minimum);
    BOOST_REQUIRE(raw == data);

    messages::compact_filter_checkpoint instance;
    BOOST_REQUIRE_EQUAL(false, instance.from_data(messages::compact_filter_checkpoint::version_minimum - 1, data));
}
...
BOOST_AUTO_TEST_CASE(compact_filter_checkpoint__factory_1__valid_input__success)
{
    ...
    messages::compact_filter_checkpoint expected;
    expected.from_data(messages::compact_filter_checkpoint::version_minimum, raw);
    const auto data = expected.to_data(messages::compact_filter_checkpoint::version_minimum);
    BOOST_REQUIRE(raw == data);

    const auto result = messages::compact_filter_checkpoint::factory(messages::compact_filter_checkpoint::version_minimum, data);

    BOOST_REQUIRE(result.is_valid());
    BOOST_REQUIRE(expected == result);
    BOOST_REQUIRE_EQUAL(data.size(), result.serialized_size(messages::compact_filter_checkpoint::version_minimum));
...
BOOST_AUTO_TEST_CASE(compact_filter_checkpoint__factory_2__valid_input__success)
{
    ...
    auto result = messages::compact_filter_checkpoint::factory(messages::compact_filter_checkpoint::version_minimum, istream);
...
BOOST_AUTO_TEST_CASE(compact_filter_checkpoint__factory_3__valid_input__success)
{
    ...
    const auto result = messages::compact_filter_checkpoint::factory(messages::compact_filter_checkpoint::version_minimum, source);
...
BOOST_AUTO_TEST_CASE(compact_filter_checkpoint__stop_hash_accessor_2__always__returns_initialized_value)
{
    ...
    const messages::compact_filter_checkpoint instance(filter_type, stop_hash, filter_headers);
...
BOOST_AUTO_TEST_CASE(compact_filter_checkpoint__operator_boolean_equals__duplicates__returns_true)
{
    ...
    messages::compact_filter_checkpoint instance(expected);
