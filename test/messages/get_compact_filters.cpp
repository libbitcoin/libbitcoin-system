...
BOOST_AUTO_TEST_CASE(get_compact_filters__constructor_4__always__equals_params)
{
    ...
    messages::get_compact_filters instance(value);
    BOOST_REQUIRE(instance.is_valid());
    BOOST_REQUIRE(filter_type == instance.filter_type());
    BOOST_REQUIRE(start_height == instance.start_height());
    BOOST_REQUIRE(stop_hash == instance.stop_hash());
...
BOOST_AUTO_TEST_CASE(get_compact_filters__constructor_5__always__equals_params)
{
    ...
    messages::get_compact_filters instance(std::move(value));
    BOOST_REQUIRE(instance.is_valid());
    BOOST_REQUIRE(filter_type == instance.filter_type());
    BOOST_REQUIRE(start_height == instance.start_height());
    BOOST_REQUIRE(stop_hash == instance.stop_hash());
...
BOOST_AUTO_TEST_CASE(get_compact_filters__from_data__insufficient_bytes__failure)
{
    ...
    messages::get_compact_filters instance;
    BOOST_REQUIRE_EQUAL(false, instance.from_data(messages::get_compact_filters::version_minimum, raw));
}
...
BOOST_AUTO_TEST_CASE(get_compact_filters__from_data__insufficient_version__failure)
{
    ...
    messages::get_compact_filters expected;
    const auto result = expected.from_data(messages::get_compact_filters::version_minimum, raw);
    BOOST_REQUIRE_EQUAL(true, result);
    BOOST_REQUIRE_EQUAL(true, expected.is_valid());

    const auto data = expected.to_data(messages::get_compact_filters::version_minimum);
    BOOST_REQUIRE(raw == data);

    messages::get_compact_filters instance;
    BOOST_REQUIRE_EQUAL(false, instance.from_data(messages::get_compact_filters::version_minimum - 1, data));
}
...
BOOST_AUTO_TEST_CASE(get_compact_filters__factory_1__valid_input__success)
{
    ...
    messages::get_compact_filters expected;
    expected.from_data(messages::get_compact_filters::version_minimum, raw);
    const auto data = expected.to_data(messages::get_compact_filters::version_minimum);
    BOOST_REQUIRE(raw == data);

    const auto result = messages::get_compact_filters::factory(messages::get_compact_filters::version_minimum, data);
    BOOST_REQUIRE(result.is_valid());
    BOOST_REQUIRE(expected == result);
    BOOST_REQUIRE_EQUAL(data.size(), result.serialized_size(messages::get_compact_filters::version_minimum));
    BOOST_REQUIRE_EQUAL(expected.serialized_size(messages::get_compact_filters::version_minimum), result.serialized_size(messages::get_compact_filters::version_minimum));
}
...
BOOST_AUTO_TEST_CASE(get_compact_filters__factory_2__valid_input__success)
{
    ...
    const auto result = messages::get_compact_filters::factory(messages::get_compact_filters::version_minimum, istream);
...
BOOST_AUTO_TEST_CASE(get_compact_filters__factory_3__valid_input__success)
{
    ...
    const auto result = messages::get_compact_filters::factory(messages::get_compact_filters::version_minimum, source);
...
BOOST_AUTO_TEST_CASE(get_compact_filters__filter_type_accessor__always__initialized_value)
{
...
BOOST_AUTO_TEST_CASE(get_compact_filters__start_height_accessor__always__initialized_value)
{
    const uint8_t filter_type = 55u;
    const uint32_t start_height = 64323u;
    const hash_digest stop_hash = base16_hash("bb5b26270e07d26283238bcbefb622682a43e9c5bb51a8276b3309f7553d4040");
...
BOOST_AUTO_TEST_CASE(get_compact_filters__stop_hash_accessor_1__always__initialized_value)
{
    const uint8_t filter_type = 55u;
    const uint32_t start_height = 64323u;
...
BOOST_AUTO_TEST_CASE(get_compact_filters__stop_hash_accessor_2__always__initialized_value)
{
    const uint8_t filter_type = 55u;
    const uint32_t start_height = 64323u;
    const hash_digest stop_hash = base16_hash("4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b");
...
BOOST_AUTO_TEST_CASE(get_compact_filters__operator_boolean_equals__duplicates__true)
{
...
BOOST_AUTO_TEST_CASE(get_compact_filters__operator_boolean_equals__differs__false)
{
    const messages::get_compact_filters expected(
        19u,
        2341u,
...
BOOST_AUTO_TEST_CASE(get_compact_filters__operator_boolean_not_equals__duplicates__false)
{
    const messages::get_compact_filters expected(
        19u,
        3546u,
...
BOOST_AUTO_TEST_CASE(get_compact_filters__operator_boolean_not_equals__differs__true)
{
    const messages::get_compact_filters expected(
        19u,
        549u,
