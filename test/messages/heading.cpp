...
BOOST_AUTO_TEST_CASE(heading__id__set__expected)
{
    ...
    instance.set_command(messages::compact_transactions::command);
    BOOST_REQUIRE(instance.id() == messages::identifier::compact_transactions);
    instance.set_command(messages::compact_block::command);
    BOOST_REQUIRE(instance.id() == messages::identifier::compact_block);
    instance.set_command(messages::client_filter::command);
    BOOST_REQUIRE(instance.id() == messages::identifier::client_filter);
    instance.set_command(messages::client_filter_checkpoint::command);
    BOOST_REQUIRE(instance.id() == messages::identifier::client_filter_checkpoint);
    instance.set_command(messages::client_filter_headers::command);
    BOOST_REQUIRE(instance.id() == messages::identifier::client_filter_headers);
    instance.set_command(messages::fee_filter::command);
    BOOST_REQUIRE(instance.id() == messages::identifier::fee_filter);
    instance.set_command(messages::bloom_filter_add::command);
    BOOST_REQUIRE(instance.id() == messages::identifier::bloom_filter_add);
    instance.set_command(messages::bloom_filter_clear::command);
    BOOST_REQUIRE(instance.id() == messages::identifier::bloom_filter_clear);
    instance.set_command(messages::bloom_filter_load::command);
    BOOST_REQUIRE(instance.id() == messages::identifier::bloom_filter_load);
    instance.set_command(messages::get_address::command);
    BOOST_REQUIRE(instance.id() == messages::identifier::get_address);
    instance.set_command(messages::get_compact_transactions::command);
    BOOST_REQUIRE(instance.id() == messages::identifier::get_compact_transactions);
    instance.set_command(messages::get_blocks::command);
    BOOST_REQUIRE(instance.id() == messages::identifier::get_blocks);
    instance.set_command(messages::get_client_filter_checkpoint::command);
    BOOST_REQUIRE(instance.id() == messages::identifier::get_client_filter_checkpoint);
    instance.set_command(messages::get_client_filter_headers::command);
    BOOST_REQUIRE(instance.id() == messages::identifier::get_client_filter_headers);
    instance.set_command(messages::get_client_filters::command);
    BOOST_REQUIRE(instance.id() == messages::identifier::get_client_filters);
    ...
    instance.set_command(messages::version_acknowledge::command);
    BOOST_REQUIRE(instance.id() == messages::identifier::version_acknowledge);
