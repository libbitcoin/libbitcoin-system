...
static const messages::compact_block_item::list expected_transactions
{
    messages::compact_block_item(10, chain::transaction(1, 48, chain::inputs{}, {})),
    messages::compact_block_item(20, chain::transaction(2, 32, chain::inputs{}, {})),
    messages::compact_block_item(30, chain::transaction(4, 16, chain::inputs{}, {}))
};
...
BOOST_AUTO_TEST_CASE(compact_block__constructor_3__always__equals_params)
{
    ...
    messages::compact_block_item::list dup_transactions = expected_transactions;
...
{
    messages::compact_block_item::list dup(expected_transactions);
    messages::compact_block instance;
    BOOST_REQUIRE(expected_transactions != instance.transactions());
