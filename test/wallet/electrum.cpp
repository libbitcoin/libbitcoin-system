...
BOOST_AUTO_TEST_CASE(electrum__create_mnemonic__en_dictionary_prefix__valid)
{
    ...
    BOOST_REQUIRE(electrum::validate_mnemonic(mnemonic, language::electrum::en, electrum::seed_prefix::standard));
}
...
BOOST_AUTO_TEST_CASE(electrum__create_mnemonic__ja_dictionary_prefix__valid)
{
    ...
    BOOST_REQUIRE(electrum::validate_mnemonic(mnemonic, language::electrum::ja, electrum::seed_prefix::standard));
    const auto seed = electrum::decode_mnemonic(mnemonic);
...
BOOST_AUTO_TEST_CASE(electrum__create_mnemonic__es_dictionary_prefix_witness__valid)
{
    ...
    BOOST_REQUIRE(electrum::validate_mnemonic(mnemonic, language::electrum::es, electrum::seed_prefix::witness));
    const auto seed = electrum::decode_mnemonic(mnemonic);
...
BOOST_AUTO_TEST_CASE(electrum__create_mnemonic__es_dictionary_prefix_standard__valid)
{
    ...
    BOOST_REQUIRE(electrum::validate_mnemonic(mnemonic, language::electrum::es, electrum::seed_prefix::standard));
}
