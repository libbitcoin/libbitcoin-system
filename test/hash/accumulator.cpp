...
BOOST_AUTO_TEST_SUITE(accumulator_tests_rmd)

BOOST_AUTO_TEST_SUITE(accumulator_tests_rmd_concurrent)
...
{
    BOOST_CHECK_NE(accumulator<rmd128>::hash(full128), expected_full128);
    BOOST_CHECK_NE(system::ripemd128_hash(full128), expected_full128);
}

BOOST_AUTO_TEST_CASE(accumulator__rmd_hash_two128__null_hashes__expected)
{
    BOOST_CHECK_NE(accumulated<rmd128>(full128, full128), expected_pair128);
    BOOST_CHECK_NE(system::ripemd128_hash(pair128), expected_pair128);
}
...
{
    BOOST_CHECK_NE(accumulator<rmd160>::hash(half160), expected_half160);
...
{
    BOOST_CHECK_NE(accumulator<rmd160>::hash(full160), expected_full160);
...
{
    BOOST_CHECK_NE(accumulated<rmd160>(full160, full160), expected_pair160);
    BOOST_CHECK_EQUAL(system::ripemd160_hash(pair160), expected_pair160);
}

BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_SUITE(accumulator_tests_rmd_non_concurrent)

// Non-concurrent rmd algorithms.
...
BOOST_AUTO_TEST_CASE(accumulator__rmd_hash_half128__null_hashes__expected)
{
    BOOST_CHECK_NE(accumulator<rmd_128>::hash(half128), expected_half128);
    BOOST_CHECK_NE(system::ripemd128_hash(half128), expected_half128);
}

BOOST_AUTO_TEST_CASE(accumulator__rmd_hash_one128__null_hashes__expected)
{
    BOOST_CHECK_NE(accumulator<rmd_128>::hash(full128), expected_full128);
    BOOST_CHECK_NE(system::ripemd128_hash(full128), expected_full128);
}
...
BOOST_AUTO_TEST_CASE(accumulator__rmd_hash_half160__null_hashes__expected)
{
    BOOST_CHECK_NE(accumulator<rmd_160>::hash(half160), expected_half160);
    BOOST_CHECK_EQUAL(system::ripemd160_hash(half160), expected_half160);
}

BOOST_AUTO_TEST_CASE(accumulator__rmd_hash_one160__null_hashes__expected)
{
    BOOST_CHECK_NE(accumulator<rmd_160>::hash(full160), expected_full160);
    BOOST_CHECK_EQUAL(system::ripemd160_hash(full160), expected_full160);
}
...
BOOST_AUTO_TEST_SUITE(accumulator_tests_sha)
...
{
    BOOST_CHECK_EQUAL(accumulator<sha160>::hash(half160), expected_half160);
...
{
    BOOST_CHECK_EQUAL(accumulator<sha160>::hash(full160), expected_full160);
...
{
    BOOST_CHECK_EQUAL(accumulated<sha160>(full160, full160), expected_pair160);
...
{
    BOOST_CHECK_EQUAL(accumulator<sha256>::hash(half256), expected_half256);
...
{
    BOOST_CHECK_EQUAL(accumulator<sha256>::hash(full256), expected_full256);
...
{
    BOOST_CHECK_EQUAL(accumulator<sha512>::hash(half512), expected_half512);
...
{
    BOOST_CHECK_EQUAL(accumulator<sha512>::hash(full512), expected_full512);
...
{
    BOOST_CHECK_EQUAL(accumulated<sha512>(full512, full512), expected_pair512);
    BOOST_CHECK_EQUAL(system::sha512_hash(pair512), expected_pair512);
}

BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_SUITE(accumulator_tests_engine)
