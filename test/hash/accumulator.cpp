...
BOOST_AUTO_TEST_SUITE(accumulator_rmd_tests)
...
{
    BOOST_CHECK_EQUAL(accumulator<rmd128>::hash(half128), expected_half128);
...
{
    BOOST_CHECK_EQUAL(accumulator<rmd128>::hash(full128), expected_full128);
...
{
    BOOST_CHECK_EQUAL(accumulated<rmd128>(full128, full128), expected_pair128);
...
{
    BOOST_CHECK_EQUAL(accumulator<rmd160>::hash(half160), expected_half160);
...
{
    BOOST_CHECK_EQUAL(accumulator<rmd160>::hash(full160), expected_full160);
...
{
    BOOST_CHECK_EQUAL(accumulated<rmd160>(full160, full160), expected_pair160);
...
{
    BOOST_CHECK_EQUAL(accumulator<rmd_128>::hash(half128), expected_half128);
    BOOST_CHECK_EQUAL(ripemd128_hash(half128), expected_half128);
}

BOOST_AUTO_TEST_CASE(accumulator__rmd_hash_one128__null_hashes__expected)
{
    BOOST_CHECK_EQUAL(accumulator<rmd_128>::hash(full128), expected_full128);
    BOOST_CHECK_EQUAL(ripemd128_hash(full128), expected_full128);
}

BOOST_AUTO_TEST_CASE(accumulator__rmd_hash_two128__null_hashes__expected)
{
    BOOST_CHECK_EQUAL(accumulated<rmd_128>(full128, full128), expected_pair128);
    BOOST_CHECK_EQUAL(ripemd128_hash(pair128), expected_pair128);
}
...
{
    BOOST_CHECK_EQUAL(accumulator<rmd_160>::hash(half160), expected_half160);
    BOOST_CHECK_EQUAL(ripemd160_hash(half160), expected_half160);
}

BOOST_AUTO_TEST_CASE(accumulator__rmd_hash_one160__null_hashes__expected)
{
    BOOST_CHECK_EQUAL(accumulator<rmd_160>::hash(full160), expected_full160);
    BOOST_CHECK_EQUAL(ripemd160_hash(full160), expected_full160);
}

BOOST_AUTO_TEST_CASE(accumulator__rmd_hash_two160__null_hashes__expected)
{
    BOOST_CHECK_EQUAL(accumulated<rmd_160>(full160, full160), expected_pair160);
    BOOST_CHECK_EQUAL(ripemd160_hash(pair160), expected_pair160);
}
...
BOOST_AUTO_TEST_SUITE(accumulator_sha_tests)
...
BOOST_AUTO_TEST_CASE(accumulator__sha_hash_two256__null_hashes__expected)
{
    ...
    BOOST_CHECK_EQUAL(sha256_hash_slice(full256, full256), sha256_hash(pair256));
}
