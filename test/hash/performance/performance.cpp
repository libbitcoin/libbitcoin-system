...
struct v2
{
    ...
    static constexpr size_t s = sub1(128);
};

struct v3
{
    static constexpr size_t c = 16 * 1024 * 1024;
    static constexpr size_t s = sub1(64);
};

struct v4
{
    static constexpr size_t c = 32 * 1024 * 1024;
    static constexpr size_t s = sub1(32);
};
...
////BOOST_AUTO_TEST_CASE(performance__sha256__algorithm)
////{
////    auto complete = true;
////    ////complete = test_algorithm<sha256a, v0::c, v0::s>(std::cout);
////    ////complete = test_algorithm<sha256a, v1::c, v1::s>(std::cout);
////    ////complete = test_algorithm<sha256a, v2::c, v2::s>(std::cout);
////    complete = test_algorithm<sha256a, v3::c, v3::s>(std::cout);
////    complete = test_algorithm<sha256a, v4::c, v4::s>(std::cout);
////    BOOST_CHECK(complete);
////}
////
