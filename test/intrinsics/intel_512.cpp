...
BOOST_AUTO_TEST_CASE(intrinsics__intel_512__madd52lo__expected)
{
    if constexpr (have_512)
    {
        ...
        const auto xword = f::madd52lo<64>(f::set<xint512_t>(7_u64, 1_u64, 0_u64, max_uint64, 0_u64, 0_u64, 0_u64, 9_u64), f::set<xint512_t>(max52, high, 1_u64, 1_u64, 0_u64, max52, 3_u64, 0_u64), f::set<xint512_t>(max52, 5_u64, 0_u64, 2_u64, max52, 1_u64, 3_u64, max52));
...
BOOST_AUTO_TEST_CASE(intrinsics__intel_512__madd52hi__expected)
{
    if constexpr (have_512)
    {
        constexpr auto max52 = 0x000fffffffffffff_u64;
        constexpr auto high = 0x8000000000000003_u64;
        const auto xword = f::madd52hi<64>(f::set<xint512_t>(7_u64, 1_u64, 0_u64, 3_u64, 0_u64, 0_u64, 0_u64, 9_u64), f::set<xint512_t>(max52, high, 1_u64, max52, 0_u64, max52, 3_u64, 0_u64), f::set<xint512_t>(max52, 5_u64, 0_u64, 2_u64, max52, 1_u64, 3_u64, max52));
