...
static_assert(h256<256>::chunk_pad.size() == 8);
static_assert(h256<256>::chunk_pad[0] == 0x80000000);
static_assert(h256<256>::chunk_pad[7] == 0x00000100);
static_assert(h256<256>::block_pad.size() == 16);
static_assert(h256<256>::block_pad[0] == 0x80000000);
static_assert(h256<256>::block_pad[15] == 0x00000200);
static_assert(h256<256>::buffer_pad.size() == 64);
static_assert(h256<256>::buffer_pad[0] == 0x80000000);
static_assert(h256<256>::buffer_pad[63] == 0x85a7a484);
static_assert(h256<256>::stream_pad.size() == 16);
static_assert(h256<256>::stream_pad[0] == 0x80000000);
static_assert(h256<256>::stream_pad[15] == 0x00000000);
