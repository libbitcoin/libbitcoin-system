...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::push_size_0, flags::no_rules) == "zero");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::push_size_0, flags::all_rules) == "zero");
}
...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::push_size_42, flags::no_rules) == "push_42");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::push_size_42, flags::all_rules) == "push_42");
}
...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::push_one_size, flags::no_rules) == "pushdata1");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::push_one_size, flags::all_rules) == "pushdata1");
}
...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::push_two_size, flags::no_rules) == "pushdata2");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::push_two_size, flags::all_rules) == "pushdata2");
}
...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::push_four_size, flags::no_rules) == "pushdata4");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::push_four_size, flags::all_rules) == "pushdata4");
}
...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::reserved_80, flags::no_rules) == "reserved");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::reserved_80, flags::all_rules) == "reserved");
}

BOOST_AUTO_TEST_CASE(opcode__opcode_to_mnemonic__push_positive_7_any_forks__7)
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::push_positive_7, flags::no_rules) == "7");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::push_positive_7, flags::all_rules) == "7");
}
...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::op_ver, flags::no_rules) == "ver");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::op_ver, flags::all_rules) == "ver");
}
...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::op_verif, flags::no_rules) == "verif");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::op_verif, flags::all_rules) == "verif");
}
...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::op_vernotif, flags::no_rules) == "vernotif");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::op_vernotif, flags::all_rules) == "vernotif");
}
...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::drop2, flags::no_rules) == "2drop");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::drop2, flags::all_rules) == "2drop");
}
...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::dup2, flags::no_rules) == "2dup");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::dup2, flags::all_rules) == "2dup");
}
...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::dup3, flags::no_rules) == "3dup");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::dup3, flags::all_rules) == "3dup");
}
...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::over2, flags::no_rules) == "2over");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::over2, flags::all_rules) == "2over");
}
...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::rot2, flags::no_rules) == "2rot");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::rot2, flags::all_rules) == "2rot");
}
...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::swap2, flags::no_rules) == "2swap");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::swap2, flags::all_rules) == "2swap");
}
...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::add1, flags::no_rules) == "1add");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::add1, flags::all_rules) == "1add");
}
...
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::sub1, flags::no_rules) == "1sub");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::sub1, flags::all_rules) == "1sub");
}
...
BOOST_AUTO_TEST_CASE(opcode__opcode_to_mnemonic__nop2_or_checklocktimeverify_any_fork_except_bip65__nop2)
{
    ...
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop2, flags::no_rules) == "nop2");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop2, flags::bip16_rule) == "nop2");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop2, flags::bip30_rule) == "nop2");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop2, flags::bip34_rule) == "nop2");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop2, flags::bip42_rule) == "nop2");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop2, flags::bip66_rule) == "nop2");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop2, flags::bip112_rule) == "nop2");
}
...
{
    static_assert(opcode::checklocktimeverify == opcode::nop2, "nop2 drift");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop2, flags::bip65_rule) == "checklocktimeverify");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop2, flags::all_rules) == "checklocktimeverify");
}
...
BOOST_AUTO_TEST_CASE(opcode__opcode_to_mnemonic__nop3_or_checksequenceverify_any_fork_except_bip112__nop3)
{
    ...
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop3, flags::no_rules) == "nop3");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop3, flags::bip16_rule) == "nop3");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop3, flags::bip30_rule) == "nop3");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop3, flags::bip34_rule) == "nop3");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop2, flags::bip42_rule) == "nop2");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop3, flags::bip66_rule) == "nop3");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop3, flags::bip65_rule) == "nop3");
}
...
{
    static_assert(opcode::checksequenceverify == opcode::nop3, "nop3 drift");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop3, flags::bip112_rule) == "checksequenceverify");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::nop3, flags::all_rules) == "checksequenceverify");
}

// All codes above 'nop10' serialize as hex.
BOOST_AUTO_TEST_CASE(opcode__opcode_to_mnemonic__reserved_186_any_forks__0xba)
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::reserved_186, flags::no_rules) == "0xba");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::reserved_186, flags::all_rules) == "0xba");
}

// All codes above 'nop10' serialize as hex.
BOOST_AUTO_TEST_CASE(opcode__opcode_to_mnemonic__reserved_255_any_forks__0xff)
{
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::reserved_255, flags::no_rules) == "0xff");
    BOOST_REQUIRE(opcode_to_mnemonic(opcode::reserved_255, flags::all_rules) == "0xff");
}
