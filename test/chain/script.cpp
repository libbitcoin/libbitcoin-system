...
BOOST_AUTO_TEST_CASE(script__verify__bip143_native_p2wsh_1_tx__success)
{
    ...
    BOOST_REQUIRE_EQUAL(tx.connect({ flags::bip141_rule }, 1), error::op_check_sig_verify10);
...
BOOST_AUTO_TEST_CASE(script__verify__bip143_no_find_and_delete_tx__success)
{
    ...
    BOOST_REQUIRE_EQUAL(tx.connect({ flags::bip16_rule | flags::bip141_rule }, 0), error::op_check_sig_verify10);
}
