...
////
////    chain::block instance;
////    BOOST_REQUIRE(instance.from_data(raw_block, true));
////    BOOST_REQUIRE(instance.is_valid_merkle_root());
////}
////
...
////{
////    const auto data = to_chunk(base16_array(
...
////    BOOST_REQUIRE(genesis.header().merkle_root() == genesis.generate_merkle_root(false));
////}
////
...
////    const chain::block block(stream, true);
////
////    BOOST_REQUIRE(block.is_valid());
////    BOOST_REQUIRE(genesis.header() == block.header());
////
...
////
////    // Save genesis block.
////    data_chunk data = genesis.to_data(false);
////    BOOST_REQUIRE_EQUAL(data.size(), 285u);
////
////    // Reload genesis block.
...
////{
////    chain::block empty;
////    BOOST_REQUIRE(empty.generate_merkle_root(false) == null_hash);
////}
////
...
////    BOOST_REQUIRE(block100k.from_data(raw, true));
////    BOOST_REQUIRE(block100k.is_valid());
////
////    const auto serial = block100k.to_data(false);
