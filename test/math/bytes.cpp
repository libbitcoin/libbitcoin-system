...
BOOST_AUTO_TEST_CASE(bytes__to_little_end__not_constant_evaluated_signed__expected)
{
...
BOOST_AUTO_TEST_CASE(bytes__from_big_end__not_constant_evaluated_signed__expected)
{
...
BOOST_AUTO_TEST_CASE(bytes__from_big_end__not_constant_evaluated_unsigned__expected)
{
...
BOOST_AUTO_TEST_CASE(bytes__from_little_end__not_constant_evaluated_signed__expected)
{
...
BOOST_AUTO_TEST_CASE(bytes__from_little_end__not_constant_evaluated_unsigned__expected)
{
