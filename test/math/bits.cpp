...
static_assert(bit_right<uint32_t>() == 0x00000001u);
static_assert(bit_right<uint64_t>() == 0x0000000000000001ul);
...
static_assert(mask_left<uint32_t>() == 0x7ffffffful);
static_assert(mask_left<uint64_t>() == 0x7ffffffffffffffful);
...
static_assert(mask_left<uint32_t>(0xffffffff, 8) == 0x00fffffful);
static_assert(mask_left<uint64_t>(0xffffffffffffffff, 8) == 0x00ffffffffffffffull);
...
static_assert(mask_right<uint64_t>() == 0xfffffffffffffffeul);
...
static_assert(unmask_left<uint64_t>() == 0x8000000000000000ul);
