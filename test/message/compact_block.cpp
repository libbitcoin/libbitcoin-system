...
{
    auto raw_left = left.to_data(message::compact_block::version_minimum);
    auto raw_right = right.to_data(message::compact_block::version_minimum);
...
BOOST_AUTO_TEST_CASE(from_data_insufficient_version_failure)
{
    ...
    BOOST_REQUIRE(expected.transactions.back().from_data(
        message::compact_block::version_minimum, to_chunk(base16_literal(
    ...
    const auto data = expected.to_data(
        message::compact_block::version_minimum);
    message::compact_block instance{};
