...
BOOST_AUTO_TEST_CASE(unicode_ofstream__conditional__test)
{
...
BOOST_AUTO_TEST_CASE(unicode_ofstream__non_ascii__test)
{
    const auto utf8 = "テスト";
...
BOOST_AUTO_TEST_CASE(unicode_ofstream__overflow__test)
{
