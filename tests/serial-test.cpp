...
int main()
{
    data_chunk rawdat(bytes_from_pretty("46682488f0a721124a3905a1bb72445bf13493e2cd46c5c0c8db1c15afa0d58e00000000"));
    ...
    log_debug() << pretty_hex(outpoint.hash) << " : " << outpoint.index;
