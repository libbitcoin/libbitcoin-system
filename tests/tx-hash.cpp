...
void hash_cmp_tx_b67d0729a14fcd45f88e53f7ec646abb47ed0a52dcdaeae28783a0038dae15c6()
{
    ...
    libbitcoin::net::message::transaction_input tx_input{
        {0x39, 0x7f, 0x72, 0x33, 0x34, 0xe2, 0x85, 0x9f, 0x00, 0x87, 0xb5, 0x64, 0xd8, 0xfb, 0xac, 0x8b, 0x2e, 0x22, 0xa2, 0xdb, 0xfc, 0x60, 0xc2, 0xdf, 0x35, 0x8d, 0x8e, 0xb4, 0xf9, 0xbe, 0xb3, 0x97},
        0,
        input_script,
        4294967295
    };
    ...
    libbitcoin::net::message::transaction_output tx_output_1;
    ...
    libbitcoin::net::message::transaction_output tx_output_2;
    tx_output_2.value = 4223000000;
    tx_output_2.output_script = output_script_2;

    libbitcoin::net::message::transaction tx;
    tx.version = 1;
    tx.locktime = 0;
