...
main()
{
    ...
    build_the_primary_and_all_dependecies
}
...
{
    define_icu_options
    define_boost_options
    define_secp256k1_options
    define_bitcoin_options
}
...
# Define initialize the build environment functions.
#==============================================================================
parse_command_line_options()
{
    for OPTION in "$@"; do
