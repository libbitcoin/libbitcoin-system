...
class stealthTest {
	...
	private static final String SCAN_PRIVATE = "fa63521e333e4b9f6a98a142680d3aef4d8e7f79723ce0043691db55c36bd905";
	private static final String SCAN_PUBLIC = "034ea70b28d607bf3a2493102001cab35689cf2152530bf8bf8a5b594af6ae31d0";
	
	private static final String SPEND_PRIVATE = "dcc1250b51c0f03ae4e978e0256ede51dc1144e345c926262b9717b1bcc9bd1b";
	private static final String SPEND_PUBLIC = "03d5b3853bbee336b551ff999b0b1d656e65a7649037ae0dcb02b3c4ff5f29e5be";
	
	private static final String EPHEMERAL_PRIVATE = "5f70a77b32260a7a32c62242381fba2cf40c0e209e665a7959418eae4f2da22b";
	private static final String EPHEMERAL_PUBLIC = "0387ff9128d18ddcec0a8119589a62b88bc035cb9cd6db08ce5ff702a78ef8f922";
	
	private static final String STEALTH_PRIVATE = "280a9931c0a7b8f9bed96bad35f69a1431817fb77043fdff641ad48ce1e4411e";
	private static final String STEALTH_PUBLIC = "0305f6b99a44a2bdec8b484ffcee561cf9a0c3b7ea92ea8e6334e6fbc4f1c17899";
	...
	private static final String P2PKH_ADDRESS = "1Gvq8pSTRocNLDyf858o4PL3yhZm5qQDgB";
...
//	    assertTrue(decode_base16(scan_private, SCAN_PRIVATE));
//	    assertTrue(secret_to_public(scan_public, scan_private));
//	    assertEquals(encode_base16(scan_public), SCAN_PUBLIC);
//	
//	    // Receiver generates a new spend private.
//	    ec_secret spend_private;
//	    ec_compressed spend_public;
//	    assertTrue(decode_base16(spend_private, SPEND_PRIVATE));
//	    assertTrue(secret_to_public(spend_public, spend_private));
//	    assertEquals(encode_base16(spend_public), SPEND_PUBLIC);
//	
//	    // Sender generates a new ephemeral key.
//	    ec_secret ephemeral_private;
//	    ec_compressed ephemeral_public;
//	    assertTrue(decode_base16(ephemeral_private, EPHEMERAL_PRIVATE));
//	    assertTrue(secret_to_public(ephemeral_public, ephemeral_private));
//	    assertEquals(encode_base16(ephemeral_public), EPHEMERAL_PUBLIC);
//	
//	    // Sender derives stealth public, requiring ephemeral private.
//	    ec_compressed sender_public;
//	    assertTrue(uncover_stealth(sender_public, scan_public, ephemeral_private, spend_public));
//	    assertEquals(encode_base16(sender_public), STEALTH_PUBLIC);
//	
//	    // Receiver derives stealth public, requiring scan private.
//	    ec_compressed receiver_public;
//	    assertTrue(uncover_stealth(receiver_public, ephemeral_public, scan_private, spend_public));
//	    assertEquals(encode_base16(receiver_public), STEALTH_PUBLIC);
//	
//	    // Only reciever can derive stealth private, as it requires both scan and spend private.
//	    ec_secret stealth_private;
//	    assertTrue(uncover_stealth(stealth_private, ephemeral_public, scan_private, spend_private));
//	
//	    // This shows that both parties have actually generated stealth public.
//	    ec_compressed stealth_public;
//	    assertTrue(secret_to_public(stealth_public, stealth_private));
//	    assertEquals(encode_base16(stealth_public), STEALTH_PUBLIC);
//	
