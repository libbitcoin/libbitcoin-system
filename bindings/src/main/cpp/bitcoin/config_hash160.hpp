...
public:
     ...
     */
    config_hash160(const std::string& hexcode);

    /**
     * Initialization constructor.
     * @param[in]  value  The value to initialize with.
     */
    config_hash160(const libbitcoin::api::math_short_hash& value);

    /**
     * Copy constructor.
     * @param[in]  other  The object to copy into self on construct.
     */
    config_hash160(const config_hash160& other);
...
//    operator const short_hash&() const;
    const libbitcoin::api::math_short_hash& to_short_hash() const;
