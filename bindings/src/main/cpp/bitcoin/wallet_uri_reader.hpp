 ...
 */
#ifndef LIBBITCOIN__WALLET_URI_READER_HPP
#define LIBBITCOIN__WALLET_URI_READER_HPP
 ...
 */
class BC_API wallet_uri_reader : public wallet::uri_reader
{
public:

	virtual ~wallet_uri_reader();
