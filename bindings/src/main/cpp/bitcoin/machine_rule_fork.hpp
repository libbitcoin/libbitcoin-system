...
enum machine_rule_fork : machine::rule_fork
{
    ...
    bip34_activations =
		...
		machine::rule_fork::bip65_rule |
		machine::rule_fork::bip66_rule,

    /// Rules that use BIP9 bit zero first time activation.
    bip9_bit0_group =
    	machine::rule_fork::bip68_rule |
		machine::rule_fork::bip112_rule |
		machine::rule_fork::bip113_rule,

    /// Rules that use BIP9 bit one first time activation.
    bip9_bit1_group =
    	machine::rule_fork::bip141_rule |
		machine::rule_fork::bip143_rule |
		machine::rule_fork::bip147_rule,
