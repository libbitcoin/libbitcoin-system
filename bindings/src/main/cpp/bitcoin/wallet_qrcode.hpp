 ...
 */
#ifndef LIBBITCOIN__QRENCODE_HPP
#define LIBBITCOIN__QRENCODE_HPP
...
//    BC_API static bool encode(std::istream& in, std::ostream& out);
     ...
     */
    BC_API static utility_data_chunk encode(const utility_data_chunk& data);
