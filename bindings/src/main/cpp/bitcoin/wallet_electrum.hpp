 ...
 */
#ifndef LIBBITCOIN__WALLET_ELECTRUM_HPP
#define LIBBITCOIN__WALLET_ELECTRUM_HPP
 ...
 * Valid seed types.
 */
enum class wallet_seed : uint8_t
{
    standard = 1,
    witness = 2,
 ...
 * Valid seed prefixes.
 */
static const utility_data_chunk wallet_seed_prefix_standard{ 0x01 };
static const utility_data_chunk wallet_seed_prefix_witness{ 0x01, 0x00 };
static const utility_data_chunk wallet_seed_prefix_two_factor_authentication{ 0x01, 0x01 };
 ...
 */
BC_API wallet_word_list create_mnemonic(const utility_data_chunk& entropy,
    const wallet_dictionary& lexicon=language::en,
    wallet_seed prefix=electrum::seed::standard);
 ...
 */
BC_API bool validate_mnemonic(const wallet_word_list& mnemonic,
    const wallet_dictionary_list& lexicons=language::all,
    wallet_seed prefix=electrum::seed::standard);
 ...
 */
BC_API math_long_hash decode_mnemonic(const wallet_electrum_word_list& mnemonic);
