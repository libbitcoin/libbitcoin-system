 ...
 */
#ifndef LIBBITCOIN__FORMATS_BASE_58_HPP
#define LIBBITCOIN__FORMATS_BASE_58_HPP
 ...
 */
BC_API std::string encode_base58(utility_data_slice unencoded);

/**
 * Attempt to decode base58 data.
 * @return false if the input contains non-base58 characters.
 */
BC_API bool decode_base58(utility_data_chunk& out, const std::string& in);
