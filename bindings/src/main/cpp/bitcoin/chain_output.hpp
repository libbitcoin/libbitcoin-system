...
//    void set_script(chain::script&& value);
    ...
    wallet::payment_address address(
        uint8_t p2kh_version=wallet_payment_address::mainnet_p2kh,
        uint8_t p2sh_version=wallet_payment_address::mainnet_p2sh) const;

    /// The payment addresses extracted from this output as a standard script.
    wallet_payment_address_list addresses(
        uint8_t p2kh_version=wallet_payment_address::mainnet_p2kh,
        uint8_t p2sh_version=wallet_payment_address::mainnet_p2sh) const;
