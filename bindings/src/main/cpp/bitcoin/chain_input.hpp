...
class BC_API chain_input : public chain::input
{
public:
...
//    chain_input(input&& other);
    chain_input(const input& other);

//    chain_input(chain_output_point&& previous_output, chain::script&& script,
//        uint32_t sequence);
    chain_input(const chain_output_point& previous_output, const chain::script& script,
        uint32_t sequence);
...
//    input& operator=(input&& other);
    input& assign(input&& other);
//    input& operator=(const input& other);

//    bool operator==(const input& other) const;
    bool eq(const input& other) const;
//    bool operator!=(const input& other) const;

    // Deserialization.
    //-------------------------------------------------------------------------

    static input factory(const libbitcoin::api::utility_data_chunk& data, bool wire=true, bool witness=false);
...
//    static input factory(reader& source, bool wire=true, bool witness=false);
    ...
    bool from_data(const libbitcoin::api::utility_data_chunk& data, bool wire=true, bool witness=false);
...
//    bool from_data(reader& source, bool wire=true, bool witness=false);
    ...
    libbitcoin::api::utility_data_chunk to_data(bool wire=true, bool witness=false) const;
...
//    void set_witness(chain::witness&& value);
    ...
    bool extract_reserved_hash(libbitcoin::api::math_hash_digest& out) const;
