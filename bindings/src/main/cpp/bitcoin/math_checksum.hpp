 ...
 */
BC_API void append_checksum(utility_data_chunk& data);
 ...
 */
BC_API uint32_t bitcoin_checksum(utility_data_slice data);
 ...
 */
BC_API bool verify_checksum(utility_data_slice data);
