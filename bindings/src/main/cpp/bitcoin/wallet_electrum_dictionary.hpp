 ...
 */
#ifndef LIBBITCOIN__WALLET_ELECTRUM_DICTIONARY_HPP
#define LIBBITCOIN__WALLET_ELECTRUM_DICTIONARY_HPP
...
class wallet_dictionary_v1 {
public:
	wallet::dictionary_v1 getValue() {
		return value;
	}

	void setValue(wallet::dictionary_v1 value) {
		this->value = value;
	}
private:
	wallet::dictionary_v1 value;
};
