...
$JAVA_HOME/bin/javac -classpath $TARGET_DIR/lib/$LIB_NAME-$VERSION.jar -sourcepath $TEST_SRC_DIR/java $TEST_SRC_DIR/java/org/libbitcoin/$LIB_NAME/*.java -d $TARGET_DIR/test-classes
